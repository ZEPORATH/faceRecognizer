...
# FisherFace = cv2.face.FisherFaceRecognizer_create()     # Create FISHER FACE RECOGNISER
...
def getImageWithID (path):
    ...
    for imagePath in imagePaths:
        for filename in os.listdir(imagePath):
            ...
            faceImage = Image.open(img_path).convert('L')  # Open image and convert to gray
            ...
            # ID = int(os.path.split(img_path)[-1].split('.')[1])    # Retreave the ID of the array
...
def train_all_recogniser(IDs,FaceList):
    print('TRAINING......')
